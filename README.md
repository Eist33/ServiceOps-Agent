...
- 坐席工作台：独立坐席身份查看人工队列，受理工单、添加处理记录并完成解决闭环。
...
测试覆盖领域状态机、金额、归属、幂等、知识阈值、过期知识、Prompt Injection、人工接管、自动分派、坐席受理与解决、SLA、API 契约、结构化事件和刷新恢复。Playwright 覆盖客户、坐席、知识运营与质量看板场景；正式 Docker 环境使用 PostgreSQL/pgvector。
...
- 当前坐席工作台使用单个固定演示坐席，尚未接入企业账号、排班、并发抢单和实时人工聊天。
